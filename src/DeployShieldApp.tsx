          ...
          <div className="grid gap-8 lg:grid-cols-5">
            <section className="lg:col-span-2">
              ...
              <p className="mt-1 text-sm text-zinc-500">
                ...
                <strong className="text-zinc-400">owner/repo + deploy branch</strong> for direct branch promotes. An
                optional <code className="text-zinc-400">GITHUB_TOKEN</code> on the API improves shared ingest; the
                GitHub authorization you complete in onboarding drives repo listing and future per-user ingest.
              </p>
